...
|         8 | Timer   | The current timer value used when updating |

Defaults when a module starts:

| Variable  | value | min | max | rate | step | at min         | at max         | select |
|-----------+-------+-----+-----+------+------+----------------+----------------+--------+
| Ramp      | 0x9c  | 0x9c| 0xff|  0x07|  0x01| 0xfc (stop)    | 0xfc (stop)    | 0x01   |
| Intensity | 0xff  | 0xcd| 0xff|  0x01|  0x01| 0xff (reverse) | 0xff (reverse) | 0x00   |
| Frequency | 0x16  | 0x09| 0x64|  0x01|  0x01| 0xff (reverse) | 0xff (reverse) | 0x08   |
| Width     | 0x82  | 0x32| 0xc8|  0x01|  0x01| 0xff (reverse) | 0xff (reverse) | 0x04   |
