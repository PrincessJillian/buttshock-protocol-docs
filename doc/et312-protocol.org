...
** Master and Slave Link (ET-232 to ET-232)
...
** $40a1, $40a2, $40aa, $40ab, $40b3, $40b4, $40bc, $40bd - Range End Action
:PROPERTIES:
:ID:       90e753ea-ceff-4b85-a7c2-d1bad201809d
:END:
For each of the variables such as Intensity, Frequency, Ramp and so
on, this byte specifies what to do when the current value reaches
