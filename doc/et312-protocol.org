...
| $406A         | Master timer (MSB) see 0x4073 for LSB                  |
| $406B         | ??related to width mod                                 |
| $406C         | ??                                                     |
| $406D         | *Menu State*                                           |
| $406E         | not used                                               |
| $406F         | not used                                               |
...
| $4088         | *Routine timer (3 bytes) low*                          |
| $4089         | *Routine timer (3 bytes) mid*                          |
| $408A         | *Routine timer (3 bytes) high*                         |
| $408B         | *Routine timer (slower, one byte)*                     |
