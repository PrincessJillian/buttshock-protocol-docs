...
| $4088         | *Routine timer (3 bytes) low - 244Hz (409uS)*          |
| $4089         | *Routine timer (3 bytes) mid - 0.953Hz (1.048S)*       |
| $408a         | *Routine timer (3 bytes) high - (268.43S)*             |
| $408b         | *Routine timer (slower) - 30.5Hz*                      |
| $408c         | *Routine program temporary byte store*                 |
| $408d         | *Random Number Min*                                    |
| $408e         | *Random Number Max*                                    |
| $408f         | program segment if audio triggered                     |
| $4090         | *Channel A: Current Gate Value* (0x06)                 |
| $4091         | ?? (0x00)                                              |
| $4092         | ?? (0x00)                                              |
| $4093         | ?? (0x00)                                              |
| $4094         | next program segment timer (0x00)                      |
| $4095         | next program segment timer max (0xff)                  |
| $4096         | next program segment flag (0x00)                       |
| $4097         | next program segment number (0x00)                     |
...
| $4192         | ??                                                     |
| $4193         | ??                                                     |
| $4194         | next program segment timer (0x00)                      |
| $4195         | next program segment timer max (0xff)                  |
| $4196         | next program segment flag (0x00)                       |
| $4197         | next program segment number (0x00)                     |
...
| $4207         | set to show program block calltable debug mode         |
| $4208         | ??                                                     |
...
| $8020 - $803f | *User routine program table 0x80-0x9f*               |
| $8040 - $80ff | *Space for User Routines*                            |
| $8100 - $811f | *User routine program table 0xa0-0xbf*               |
| $8120 - $81ff | *Space for User Routines*                            |
*** Memory Specifics
